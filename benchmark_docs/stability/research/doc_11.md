# Acoustic Material Detection - Simplified Research Paper

Abstract
This paper presents a compact study design for Acoustic Material Detection and reports reproducible baseline findings.
