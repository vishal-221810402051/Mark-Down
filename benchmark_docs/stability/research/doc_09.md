# Liquid Vibration Sensing - Simplified Research Paper

Abstract
This paper presents a compact study design for Liquid Vibration Sensing and reports reproducible baseline findings.
