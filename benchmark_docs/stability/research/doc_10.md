# Graph Neural Networks - Simplified Research Paper

Abstract
This paper presents a compact study design for Graph Neural Networks and reports reproducible baseline findings.
