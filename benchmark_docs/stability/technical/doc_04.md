# Microfluidics Research Instrument Documentation

System Context
This document describes the architecture, interfaces, and implementation boundaries for the Microfluidics Research Instrument.
